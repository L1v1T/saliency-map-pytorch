...
from models.cnnmnist import CNN_MNIST
...
def main():
    ...
    train_set = utils.datasets.MNISTDataset('../data', train=True, download=True,
                    transform=transforms.Compose([
                        transforms.ToTensor(),
                        transforms.Normalize((0.5,), (0.5,))
                    ]))

    train_loader = utils.dataloader.DataLoader(train_set, batch_size=args.batch_size)
    
    test_loader = utils.dataloader.DataLoader(
        utils.datasets.MNISTDataset('../data', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.5,), (0.5,))
                       ])),
